...
public class ImageResizer extends ImageWorker {
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        {
            LogUtil.e("performance", "Error, image is to large width = " + width + ", height = " + height);
        }
        ...
        LogUtil.i("performance", "inSampleSize = " + inSampleSize);
        return inSampleSize;
    }
    
    /* Copy from {@link android.media.ThumbnailUtils} */
    /*
    ...
    private static int computeSampleSize(BitmapFactory.Options options,
        ...
        int initialSize = computeInitialSampleSize(options, minSideLength * 2,
                maxNumOfPixels * 2);
        ...
        LogUtil.e("performance", "inSampleSize = " + roundedSize);
        return roundedSize;
    }
