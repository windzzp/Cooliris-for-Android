...
public class ImageDBLoader {
    ...
    public static ArrayList<ImageGroup> loadAllGirls() {
        ...
        LogUtil.i(TAGConstant.TAG_PERFORMANCE, "Load images takes time = " + (System.currentTimeMillis() - start));
    ...
    public static ArrayList<ImageGroup> loadOnlyGirls() {
        ...
        LogUtil.i(TAGConstant.TAG_PERFORMANCE, "Create empty images takes time = "
