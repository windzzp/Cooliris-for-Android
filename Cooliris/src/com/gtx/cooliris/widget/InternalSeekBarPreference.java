...
public class InternalSeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public InternalSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public InternalSeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
